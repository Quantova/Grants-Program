...
**Repository:** `Grants-Program` — Quantova Grants Program
...
This repository hosts the Quantova Grants Program — its application templates, process, and documentation — and forms part of this stack.
...
- **Licensed Work:** `Grants-Program` — Quantova Grants Program, © 2026 Quantova Inc.
...
This repository hosts the Quantova Grants Program: the application template and intake process, RFPs, milestone-delivery process, terms and conditions, and supporting documentation. It contains documentation and templates only. It does not contain private keys, secrets, or funded-account material.

Note: this BUSL-1.1 license applies to the contents of this repository (its templates and documentation). Work funded by the Program is released by grantees under their own recognized open-source license (for example Apache-2.0, MIT, or GPLv3), as described in the Terms and Conditions.
