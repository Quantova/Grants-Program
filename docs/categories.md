# Funding Categories & Project Ideas

The Quantova Grants Program funds open-source work that strengthens the Quantova
ecosystem. Below are the categories we fund and example ideas. This is not
exhaustive — strong proposals outside these examples are welcome, as long as the
relation to Quantova is clear.
...
- Wallet integrations and signing tooling around QMask and the post-quantum
  account model.
...
- Research and implementations related to Quantova's NIST post-quantum stack
...
Suggest it as a Request for Proposals — see [../rfps/README.md](../rfps/README.md).
